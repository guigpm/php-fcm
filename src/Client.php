...
class Client implements ClientInterface
{
     ...
     * @throws \GuzzleHttp\Exception\RequestException
	 */
	private function request($host, $path, Message $data)
	{
    ...
    {
        return isset($this->proxyApiUrl) ? $this->proxyApiUrl : ((trim($host) and trim($path)) ? sprintf( 'https://%s/%s', $host, $path ) : self::DEFAULT_API_URL);
    }
}
